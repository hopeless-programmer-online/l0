(module
    ...
    ;; { types
        ...
        ;; (func $type.List.instance     (result i32) i32.const 25 return)
    ;; }
    ...
    ;; { tables
        ...
        ;; { print
            (func $virtual.print.offset (result i32) i32.const 27)
            (elem (i32.const 27)
        ...
        ;; { type
            (func $virtual.type.offset (result i32) i32.const 54)
            (elem (i32.const 54)
